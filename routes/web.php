...
Route::delete('/questionnaires/{questionnaire}/delete', [QuestionnaireController::class, 'destroy']);


// QuestionController
Route::get('/questionnaires/{questionnaire}/questions/create', [QuestionController::class, 'create']);
Route::post('/questionnaires/{questionnaire}/question', [QuestionController::class, 'store']);
